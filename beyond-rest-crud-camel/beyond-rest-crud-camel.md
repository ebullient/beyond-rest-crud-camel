...
::: block
➕
:::<!-- element style="margin-top: 10%; margin-left: 1em; margin-right: 1em" -->
![girlcoding](../assets/img/profile/girlcoding.png)
</split>
:::<!-- element style="margin-top: 10%" -->

<span>Erin Schnabel, Red Hat・ [github.com/ebullient](https://github.com/ebullient) ・ [www.ebullient.dev](https://www.ebullient.dev/)</span><!-- element class="footer" -->  
<span>Zineb Bendhiba, Red Hat・ [github.com/zbendhiba](https://github.com/zbendhiba) ・ [zinebbendhiba.com](https://zinebbendhiba.com/)</span><!-- element class="footer" -->
